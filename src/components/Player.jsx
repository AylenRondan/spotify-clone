...
export const Volume = () => (
    <svg fill="currentColor" role="presentation" aria-label="Volume high" aria-hidden="true" viewBox="0 0 16 16" height="16" width="16">
...
const SongControl = ({ audio }) => {
    ...
    return (
      <div className="flex gap-x-3 text-xs pt-2">
        ...
        <span className="opacity-50 w-12 text-white">
...
export function Player () {
   ...
   const volumeRef = useRef(1);  // Puedes ajustar este valor según tus necesidades
